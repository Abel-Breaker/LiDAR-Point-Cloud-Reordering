...
CFLAGS_RELEASE       = -O2 -march=native -fopenmp -ftree-vectorize -fomit-frame-pointer -flto -static #-ffast-math #-fno-math-errno #-ffinite-math-only#-ffast-math  #-funroll-loops #-fopt-info-vec -fopt-info-vec-missed -D_FORTIFY_SOURCE=2 3 
